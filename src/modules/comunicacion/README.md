# Módulo COMUNICACION - Hexagonal Architecture
...
1. Leer `COMUNICACION_CLAUDE.md` para entender el dominio
2. Leer `COMUNICACION_ENTITIES_CLAUDE.md` para las entidades
