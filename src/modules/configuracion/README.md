# Módulo CONFIGURACION - Hexagonal Architecture
...
1. Leer `CONFIGURACION_CLAUDE.md` para entender el dominio
2. Leer `CONFIGURACION_ENTITIES_CLAUDE.md` para las entidades
